<template>
  <div class="app-container">
    <el-row :gutter="20">
      ...
      <el-col :span="20" :xs="24">
        ...
        <el-table v-loading="loading" :data="userList" @selection-change="handleSelectionChange">
          ...
          <el-table-column label="头像" align="center" key="avatar" prop="avatar" v-if="columns[0].visible">
            <template slot-scope="scope">
              <img src="@/assets/images/avatar.png" v-if="scope.row.avatar == null || scope.row.avatar == ''"
                style="height:35px">
              <img :src="scope.row.avatar" v-else style="height:35px" />
            </template>
          </el-table-column>
          ...
          <el-table-column label="实名" align="center" prop="autonym">
            <template slot-scope="scope">
              <dict-tag :options="dict.type.sys_yes_no" :value="scope.row.autonym"/>
            </template>
          </el-table-column>
    ...
    <!-- 角色分配信息 -->
    <el-dialog :title="this.dictTypeTitle" :visible.sync="rightRole" width="50%" append-to-body :close-on-click-modal="false" v-dialogDrag  :center="true">
      <el-form>
        <el-form-item style="margin: 0 auto;width: 65%;">
...
export default {
  name: "User",
  dicts: ['sys_normal_disable', 'sys_user_sex', 'sys_yes_no'],
  ...
  methods: {
    ...
    handleAuthRole: function(row) {
      this.rightRole = true
      this.dictTypeTitle = row.userName + '角色分配'
    ...
    refRoleList() {
      ...
      getAuthRole(this.userId).then((response) => {
        ...
        this.roleIds = response.user.roles
